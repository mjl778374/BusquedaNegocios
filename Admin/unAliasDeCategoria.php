...
try
{
    ...
    if (strcmp($Modo, $MODO_CAMBIO) == 0)
    {
        ...
        if (strcmp($_GET["IdCategoria"], $IdCategoria) != 0 || strcmp($_GET["IdAlias"], $IdAlias) != 0)
            header("Location: unAliasDeCategoria.php?Modo=" . $MODO_CAMBIO . "&IdCategoria=" . $IdCategoria . "&IdAlias=" . $IdAlias);
    } // if (strcmp($Modo, $MODO_CAMBIO) == 0)
    ...
    <div class="container mt-4">
        ...
        <div class="form-row justify-content-center mt-4">
            <div class="form-group col-8 col-md-6 col-lg-4">
                ...
                <button type="button" class="btn btn-primary" onclick="window.location.href='todosAliasDeCategoria.php?IdCategoria=<?php echo $IdCategoria?>';">Regresar</button>
            </div>
        </div>
    </div>
<?php
