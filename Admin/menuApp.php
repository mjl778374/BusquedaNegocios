...
else if($FormularioActivo == "AliasYCategorias" || $FormularioActivo == "Categoria"  || $FormularioActivo == "Alias")
{
    if ($FormularioActivo == "AliasYCategorias")
      $MostrarMenuBuscar = true;

    $MenuCategoriasNegociosActivo = "active";
    $NombreMenuBuscar = "AliasYCategorias_TextoXBuscar";
} // else if($FormularioActivo == "AliasYCategorias" || $FormularioActivo == "Categoria"  || $FormularioActivo == "Alias")
...
} // else if($FormularioActivo == "RegionesGeograficas" || $FormularioActivo == "Provincias" || $FormularioActivo == "Cantones")
...
<li class="nav-item dropdown <?php echo $MenuOrganizacionTerritorialActivo ?>">
      ...
      <li class="nav-item <?php echo $MenuCategoriasNegociosActivo ?>">
        <a class="nav-link" href="aliasYCategorias.php" target="_top">Categorías de Negocios</a>
      </li>
      <li class="nav-item <?php echo $MenuNegociosActivo ?>">
        <a class="nav-link" href="negocios.php" target="_top">Negocios</a>
      </li>
<?php if ($UsuarioSesionEsAdmin) { ?>
