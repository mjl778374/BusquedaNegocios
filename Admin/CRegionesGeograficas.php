...
class CRegionesGeograficas extends CSQL
{
    ...
    public function ConsultarXRegionGeografica($IdRegion, &$Existe, &$Region)
    {
    ...
    public function AltaRegionGeografica($Region, &$NumError, &$IdRegion)
    {
    ...
    public function CambioRegionGeografica($IdRegion, $Region, &$NumError)
    {
        include_once "CPalabras.php";
        include_once "CPalabrasSemejantes.php";
